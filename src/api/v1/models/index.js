...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/gravitazione/personalProj/portfolio-backend/src/api/v1/models",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "ee72b708a4044e63f273d54265db1c751ba246b3789be55ac71db2d1894b963f",
  "copyEngine": true
}
...
path.join(process.cwd(), "src/api/v1/models/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/api/v1/models/schema.prisma")
